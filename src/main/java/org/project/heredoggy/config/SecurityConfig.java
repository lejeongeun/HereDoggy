    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/members/free-posts/**", "/api/members/review-posts/**", "/api/members/missing-posts/**", "/api/members/notice-posts/**",  "/api/*-posts/*/comments", "/api/*-posts/*/likes/count").permitAll() // 게시물 조회, 댓글 조회, 좋아요 갯수는 비회원도 가능
